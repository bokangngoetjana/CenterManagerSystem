...
namespace CenterManagerSystem.Areas.Manager.Controllers
{
    ...
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Index(int categoryId)
        {
            List<CategoryItem> list = await (from catItem in _context.CategoryItem
                                             ...
                                             select new CategoryItem
                                             {
                                                 ...
                                                 Duration = catItem.Duration,
                                                 StartDate = catItem.StartDate,
                                                 EndDate = catItem.EndDate,
        ...
        // GET: Manager/CategoryItem/Details/5
        ...
        // GET: Manager/CategoryItem/Create
        ...
        // POST: Manager/CategoryItem/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CategoryId,MediaTypeId,Duration,StartDate,EndDate")] CategoryItem categoryItem)
        {
        ...
        // GET: Manager/CategoryItem/Edit/5
        ...
        // POST: Manager/CategoryItem/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CategoryId,MediaTypeId,Duration,StartDate,EndDate")] CategoryItem categoryItem)
        {
        ...
        // GET: Manager/CategoryItem/Delete/5
        ...
        // POST: Manager/CategoryItem/Delete/5
